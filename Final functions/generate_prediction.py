...
for props in regions:
    ...
    if (nArteries>nVeins):
        ...
        #predictions_image[coordinates_intersection_veins[0],coordinates_intersection_veins[1],2]=0
        ...
        #predictions_image[coordinates_intersection_arteries[0],coordinates_intersection_arteries[1],2]=1
